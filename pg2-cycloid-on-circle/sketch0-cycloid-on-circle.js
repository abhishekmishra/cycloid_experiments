class CycloidOnCycloid extends CycloidWheel {
  constructor(p, parentCycloid, centerX, centerY, radius, theta, colours = {
    circle: [0, 0, 200],
    radius: [200, 0, 0],
    centerPoint: [0, 255, 0],
  ...
  drawCycloid() {
    ...
    let newCenter = {
      x: currentOuterRimPoint.x - this.radius * this.p.cos(this.parentCycloid.theta),
      y: currentOuterRimPoint.y - this.radius * this.p.sin(this.parentCycloid.theta),
    }
    ...
    let angleInDegrees = this.p.degrees(this.p.atan2(
